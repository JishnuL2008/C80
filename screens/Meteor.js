...
import {Text,View,SafeAreaView,StyleSheet,Platform,StatusBar,FlatList,Alert,Image,ImageBackground,Dimensions} from "react-native";
...
export default class Meteor extends Component{
    ...
    getMeteors = () => {
        axios
            .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=FxgTHaOknxOV20wEwDPNigiazcR12fQiFdXGCjAv")
            .then(response => {
    ...
    renderItem=({item})=>{
        ...
        if(meteor.threat_score<=30){
          ...
          bg_image=require("../assets/meteor_g3.png")
